package com.temboo.Library.Google.ComputeEngine.MachineTypes;
...
*/
public  class ListMachineTypesResultSet extends ResultSet {
		
	public ListMachineTypesResultSet(JSONObject doc) {
		super(doc);
	}
