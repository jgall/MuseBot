package com.temboo.Library.Google.ComputeEngine.Snapshots;
...
*/
public  class DeleteSnapshotResultSet extends ResultSet {
		
	public DeleteSnapshotResultSet(JSONObject doc) {
		super(doc);
	}
