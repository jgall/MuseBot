package com.temboo.Library.Google.ComputeEngine.RegionOperations;
...
*/
public  class DeleteRegionOperationResultSet extends ResultSet {
		
	public DeleteRegionOperationResultSet(JSONObject doc) {
		super(doc);
	}
