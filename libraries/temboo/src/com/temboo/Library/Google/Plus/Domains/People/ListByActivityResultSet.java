package com.temboo.Library.Google.Plus.Domains.People;
...
*/
public  class ListByActivityResultSet extends ResultSet {
		
	public ListByActivityResultSet(JSONObject doc) {
		super(doc);
	}
