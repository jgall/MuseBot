...
*/
public  class DeleteListRowResultSet extends ResultSet {
		
	public DeleteListRowResultSet(JSONObject doc) {
		super(doc);
	}
	...
	*/
	...
	@return String - Contains a new AccessToken when the RefreshToken is provided.
	*/
