...
*/
public class CreateDraft extends Choreography {

	/**
	Create a new instance of the CreateDraft Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public CreateDraft(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Google/Gmailv2/Drafts/CreateDraft"));
	}
	...
	*/
	 ...
	 */
	@Override
	public CreateDraftResultSet run() {
		JSONObject result = super.runWithResults();
		return new CreateDraftResultSet(result);
	}
