...
public class InsertMessage extends Choreography {
	...
	*/
	public InsertMessage(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Google/Gmailv2/Messages/InsertMessage"));
	}
	...
	*/
	...
	@param String - (required, string) The address and name (optional) that the email is being sent from e.g., Dan <dan@temboo.com>.
	*/
	...
	@param String - (optional, json) An array of Gmail labels to apply to this message (e.g., ["SENT", "INBOX", "UNREAD"].
	*/
	...
	*/
	...
	@param String - (required, string) The text for the message body of the email.
	*/
	...
	*/
	...
	@param String - (required, string) The email subject.
	*/
	...
	*/
	...
	@param String - (required, string) The address and name (optional) that the email is being sent to e.g., Dan <dan@temboo.com>.
	*/
	...
	*/
	 ...
	 */
	@Override
	public InsertMessageResultSet run() {
		JSONObject result = super.runWithResults();
		return new InsertMessageResultSet(result);
	}
