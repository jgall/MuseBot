...
*/
public class RetrieveTagsByUser extends Choreography {

	/**
	Create a new instance of the RetrieveTagsByUser Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public RetrieveTagsByUser(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Google/Picasa/RetrieveTagsByUser"));
	}
	...
	*/
	 ...
	 */
	@Override
	public RetrieveTagsByUserResultSet run() {
		JSONObject result = super.runWithResults();
		return new RetrieveTagsByUserResultSet(result);
	}
