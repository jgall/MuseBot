...
*/
public class TagPhoto extends Choreography {

	/**
	Create a new instance of the TagPhoto Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public TagPhoto(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Google/Picasa/TagPhoto"));
	}
	...
	*/
	...
	@param String - (required, integer) The id of the album which contains the photo you want to tag.
	*/
	...
	*/
	...
	@param String - (required, integer) The id of the photo you want to tag.
	*/
	...
	*/
	 ...
	 */
	@Override
	public TagPhotoResultSet run() {
		JSONObject result = super.runWithResults();
		return new TagPhotoResultSet(result);
	}
