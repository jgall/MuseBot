...
*/
public class DeleteAlbum extends Choreography {

	/**
	Create a new instance of the DeleteAlbum Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public DeleteAlbum(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Google/Picasa/DeleteAlbum"));
	}
	...
	*/
	 ...
	 */
	@Override
	public DeleteAlbumResultSet run() {
		JSONObject result = super.runWithResults();
		return new DeleteAlbumResultSet(result);
	}
