...
*/
public class UserIsFollowedBy extends Choreography {

	/**
	Create a new instance of the UserIsFollowedBy Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public UserIsFollowedBy(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Instagram/UserIsFollowedBy"));
	}
	...
	*/
	 ...
	 */
	@Override
	public UserIsFollowedByResultSet run() {
		JSONObject result = super.runWithResults();
		return new UserIsFollowedByResultSet(result);
	}
