...
*/
public class GetPopularMedia extends Choreography {

	/**
	Create a new instance of the GetPopularMedia Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public GetPopularMedia(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Instagram/GetPopularMedia"));
	}
	...
	*/
	 ...
	 */
	@Override
	public GetPopularMediaResultSet run() {
		JSONObject result = super.runWithResults();
		return new GetPopularMediaResultSet(result);
	}
