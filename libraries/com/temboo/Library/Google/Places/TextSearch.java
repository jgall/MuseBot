...
public class TextSearch extends Choreography {
	...
	*/
	...
	@param String - (optional, string) Specify a latitude point around which Places results will be retrieved.  When specifying a latitude, both longitude and radius must also be supplied.
	*/
	...
	@param String - (optional, string) Specify a longitude point around which Places results will be retrieved.  When specifying a longitude, both latitude and radius must also be supplied.
	*/
