...
*/
public class RetrieveComments extends Choreography {

	/**
	Create a new instance of the RetrieveComments Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public RetrieveComments(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Google/Picasa/RetrieveComments"));
	}
	...
	*/
	...
	@param String - (optional, integer) The max number of comments to return. Defaults to 10.
	*/
	...
	*/
	 ...
	 */
	@Override
	public RetrieveCommentsResultSet run() {
		JSONObject result = super.runWithResults();
		return new RetrieveCommentsResultSet(result);
	}
