...
*/
public class ListAlbums extends Choreography {

	/**
	Create a new instance of the ListAlbums Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public ListAlbums(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Google/Picasa/ListAlbums"));
	}
	...
	*/
	 ...
	 */
	@Override
	public ListAlbumsResultSet run() {
		JSONObject result = super.runWithResults();
		return new ListAlbumsResultSet(result);
	}
