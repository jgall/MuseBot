package com.temboo.Library.Google.ComputeEngine.ZoneOperations;
...
*/
public  class DeleteZoneOperationResultSet extends ResultSet {
		
	public DeleteZoneOperationResultSet(JSONObject doc) {
		super(doc);
	}
