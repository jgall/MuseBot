...
public class AllExercises extends Choreography {
	...
	*/
	public AllExercises(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/KhanAcademy/Exercises/AllExercises"));
	}
	 ...
	 */
	@Override
	public AllExercisesResultSet run() {
		JSONObject result = super.runWithResults();
		return new AllExercisesResultSet(result);
	}
