...
*/
public class GetExerciseLog extends Choreography {

	/**
	Create a new instance of the GetExerciseLog Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public GetExerciseLog(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/KhanAcademy/Users/GetExerciseLog"));
	}
	...
	*/
	 ...
	 */
	@Override
	public GetExerciseLogResultSet run() {
		JSONObject result = super.runWithResults();
		return new GetExerciseLogResultSet(result);
	}
