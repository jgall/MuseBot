...
*/
public class GetVideo extends Choreography {

	/**
	Create a new instance of the GetVideo Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public GetVideo(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/KhanAcademy/Users/GetVideo"));
	}
	...
	*/
	 ...
	 */
	@Override
	public GetVideoResultSet run() {
		JSONObject result = super.runWithResults();
		return new GetVideoResultSet(result);
	}
