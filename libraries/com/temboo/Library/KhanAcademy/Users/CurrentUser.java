...
public class CurrentUser extends Choreography {
	...
	*/
	public CurrentUser(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/KhanAcademy/Users/CurrentUser"));
	}
	...
	*/
	 ...
	 */
	@Override
	public CurrentUserResultSet run() {
		JSONObject result = super.runWithResults();
		return new CurrentUserResultSet(result);
	}
