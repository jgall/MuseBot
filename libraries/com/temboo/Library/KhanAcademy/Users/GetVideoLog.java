...
*/
public class GetVideoLog extends Choreography {

	/**
	Create a new instance of the GetVideoLog Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public GetVideoLog(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/KhanAcademy/Users/GetVideoLog"));
	}
	...
	*/
	 ...
	 */
	@Override
	public GetVideoLogResultSet run() {
		JSONObject result = super.runWithResults();
		return new GetVideoLogResultSet(result);
	}
