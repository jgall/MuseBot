...
public class EntityOverview extends Choreography {
	...
	*/
	public EntityOverview(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/InfluenceExplorer/EntityOverview"));
	}
	...
	*/
	 ...
	 */
	@Override
	public EntityOverviewResultSet run() {
		JSONObject result = super.runWithResults();
		return new EntityOverviewResultSet(result);
	}
