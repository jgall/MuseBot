...
*/
public class ContributorTypeBreakdown extends Choreography {

	/**
	Create a new instance of the ContributorTypeBreakdown Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public ContributorTypeBreakdown(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/InfluenceExplorer/ContributorTypeBreakdown"));
	}
	...
	*/
	 ...
	 */
	@Override
	public ContributorTypeBreakdownResultSet run() {
		JSONObject result = super.runWithResults();
		return new ContributorTypeBreakdownResultSet(result);
	}
