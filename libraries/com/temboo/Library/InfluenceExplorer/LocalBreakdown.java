...
*/
public class LocalBreakdown extends Choreography {

	/**
	Create a new instance of the LocalBreakdown Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public LocalBreakdown(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/InfluenceExplorer/LocalBreakdown"));
	}
	...
	*/
	 ...
	 */
	@Override
	public LocalBreakdownResultSet run() {
		JSONObject result = super.runWithResults();
		return new LocalBreakdownResultSet(result);
	}
