...
*/
public class GetQueues extends Choreography {

	/**
	Create a new instance of the GetQueues Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public GetQueues(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Netflix/GetQueues"));
	}
	...
	*/
	 ...
	 */
	@Override
	public GetQueuesResultSet run() {
		JSONObject result = super.runWithResults();
		return new GetQueuesResultSet(result);
	}
