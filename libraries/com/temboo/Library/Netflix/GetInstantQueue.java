...
*/
public class GetInstantQueue extends Choreography {

	/**
	Create a new instance of the GetInstantQueue Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public GetInstantQueue(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Netflix/GetInstantQueue"));
	}
	...
	*/
	 ...
	 */
	@Override
	public GetInstantQueueResultSet run() {
		JSONObject result = super.runWithResults();
		return new GetInstantQueueResultSet(result);
	}
