...
public class TextToSpeech extends Choreography {
	...
	*/
	public TextToSpeech(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Nexmo/Voice/TextToSpeech"));
	}
	...
	*/
	 ...
	 */
	@Override
	public TextToSpeechResultSet run() {
		JSONObject result = super.runWithResults();
		return new TextToSpeechResultSet(result);
	}
