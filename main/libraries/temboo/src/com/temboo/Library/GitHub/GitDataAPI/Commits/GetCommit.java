...
*/
public class GetCommit extends Choreography {

	/**
	Create a new instance of the GetCommit Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public GetCommit(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/GitHub/GitDataAPI/Commits/GetCommit"));
	}
	...
	*/
	 ...
	 */
	@Override
	public GetCommitResultSet run() {
		JSONObject result = super.runWithResults();
		return new GetCommitResultSet(result);
	}
