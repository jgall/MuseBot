...
*/
public class GetForks extends Choreography {

	/**
	Create a new instance of the GetForks Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public GetForks(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/GitHub/ReposAPI/Forks/GetForks"));
	}
	...
	*/
	 ...
	 */
	@Override
	public GetForksResultSet run() {
		JSONObject result = super.runWithResults();
		return new GetForksResultSet(result);
	}
