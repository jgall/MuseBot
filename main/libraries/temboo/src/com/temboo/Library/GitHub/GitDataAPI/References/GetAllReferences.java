...
*/
public class GetAllReferences extends Choreography {

	/**
	Create a new instance of the GetAllReferences Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public GetAllReferences(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/GitHub/GitDataAPI/References/GetAllReferences"));
	}
	...
	*/
	 ...
	 */
	@Override
	public GetAllReferencesResultSet run() {
		JSONObject result = super.runWithResults();
		return new GetAllReferencesResultSet(result);
	}
