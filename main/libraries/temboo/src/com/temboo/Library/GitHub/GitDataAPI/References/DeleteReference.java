...
*/
public class DeleteReference extends Choreography {

	/**
	Create a new instance of the DeleteReference Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public DeleteReference(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/GitHub/GitDataAPI/References/DeleteReference"));
	}
	...
	*/
	 ...
	 */
	@Override
	public DeleteReferenceResultSet run() {
		JSONObject result = super.runWithResults();
		return new DeleteReferenceResultSet(result);
	}
