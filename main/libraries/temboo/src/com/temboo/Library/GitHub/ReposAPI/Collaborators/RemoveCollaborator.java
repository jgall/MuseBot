...
*/
public class RemoveCollaborator extends Choreography {

	/**
	Create a new instance of the RemoveCollaborator Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public RemoveCollaborator(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/GitHub/ReposAPI/Collaborators/RemoveCollaborator"));
	}
	...
	*/
	 ...
	 */
	@Override
	public RemoveCollaboratorResultSet run() {
		JSONObject result = super.runWithResults();
		return new RemoveCollaboratorResultSet(result);
	}
