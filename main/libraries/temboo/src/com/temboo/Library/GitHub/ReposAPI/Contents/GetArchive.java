...
*/
public class GetArchive extends Choreography {

	/**
	Create a new instance of the GetArchive Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public GetArchive(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/GitHub/ReposAPI/Contents/GetArchive"));
	}
	...
	*/
	 ...
	 */
	@Override
	public GetArchiveResultSet run() {
		JSONObject result = super.runWithResults();
		return new GetArchiveResultSet(result);
	}
