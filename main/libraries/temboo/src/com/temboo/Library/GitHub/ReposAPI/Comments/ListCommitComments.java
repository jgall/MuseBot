...
*/
public class ListCommitComments extends Choreography {

	/**
	Create a new instance of the ListCommitComments Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public ListCommitComments(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/GitHub/ReposAPI/Comments/ListCommitComments"));
	}
	...
	*/
	 ...
	 */
	@Override
	public ListCommitCommentsResultSet run() {
		JSONObject result = super.runWithResults();
		return new ListCommitCommentsResultSet(result);
	}
