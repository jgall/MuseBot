package com.temboo.Library.GitHub.ReposAPI.Forks;
...
*/
public class CreateFork extends Choreography {

	/**
	Create a new instance of the CreateFork Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public CreateFork(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/GitHub/ReposAPI/Forks/CreateFork"));
	}
	...
	*/
	 ...
	 */
	@Override
	public CreateForkResultSet run() {
		JSONObject result = super.runWithResults();
		return new CreateForkResultSet(result);
	}
