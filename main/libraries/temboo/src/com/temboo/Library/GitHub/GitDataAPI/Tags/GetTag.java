...
*/
public class GetTag extends Choreography {

	/**
	Create a new instance of the GetTag Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public GetTag(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/GitHub/GitDataAPI/Tags/GetTag"));
	}
	...
	*/
	 ...
	 */
	@Override
	public GetTagResultSet run() {
		JSONObject result = super.runWithResults();
		return new GetTagResultSet(result);
	}
