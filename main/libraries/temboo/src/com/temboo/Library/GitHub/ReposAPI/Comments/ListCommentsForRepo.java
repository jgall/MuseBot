...
*/
public class ListCommentsForRepo extends Choreography {

	/**
	Create a new instance of the ListCommentsForRepo Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public ListCommentsForRepo(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/GitHub/ReposAPI/Comments/ListCommentsForRepo"));
	}
	...
	*/
	 ...
	 */
	@Override
	public ListCommentsForRepoResultSet run() {
		JSONObject result = super.runWithResults();
		return new ListCommentsForRepoResultSet(result);
	}
