...
*/
public class ListLanguages extends Choreography {

	/**
	Create a new instance of the ListLanguages Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public ListLanguages(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/GitHub/ReposAPI/Repos/ListLanguages"));
	}
	...
	*/
	 ...
	 */
	@Override
	public ListLanguagesResultSet run() {
		JSONObject result = super.runWithResults();
		return new ListLanguagesResultSet(result);
	}
