...
*/
public class ListContributors extends Choreography {

	/**
	Create a new instance of the ListContributors Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public ListContributors(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/GitHub/ReposAPI/Repos/ListContributors"));
	}
	...
	*/
	public void setAnonymous(Boolean value) {
		this.inputs.setInput("Anonymous", value);
	}

	/** 
	Set the value of the Anonymous input for this Choreo as a String. 

	@param String - (optional, boolean) Flag indicating that the response should include anonymous contributors. Set to 1 or true to include anonymous contributors.
	*/
	...
	*/
	 ...
	 */
	@Override
	public ListContributorsResultSet run() {
		JSONObject result = super.runWithResults();
		return new ListContributorsResultSet(result);
	}
