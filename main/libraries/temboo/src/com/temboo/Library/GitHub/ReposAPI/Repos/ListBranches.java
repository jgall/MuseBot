...
*/
public class ListBranches extends Choreography {

	/**
	Create a new instance of the ListBranches Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public ListBranches(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/GitHub/ReposAPI/Repos/ListBranches"));
	}
	...
	*/
	 ...
	 */
	@Override
	public ListBranchesResultSet run() {
		JSONObject result = super.runWithResults();
		return new ListBranchesResultSet(result);
	}
