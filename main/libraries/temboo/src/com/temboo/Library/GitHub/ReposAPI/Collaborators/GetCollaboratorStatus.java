...
*/
public class GetCollaboratorStatus extends Choreography {

	/**
	Create a new instance of the GetCollaboratorStatus Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public GetCollaboratorStatus(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/GitHub/ReposAPI/Collaborators/GetCollaboratorStatus"));
	}
	...
	*/
	 ...
	 */
	@Override
	public GetCollaboratorStatusResultSet run() {
		JSONObject result = super.runWithResults();
		return new GetCollaboratorStatusResultSet(result);
	}
