...
*/
public class ListCollaborators extends Choreography {

	/**
	Create a new instance of the ListCollaborators Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public ListCollaborators(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/GitHub/ReposAPI/Collaborators/ListCollaborators"));
	}
	...
	*/
	 ...
	 */
	@Override
	public ListCollaboratorsResultSet run() {
		JSONObject result = super.runWithResults();
		return new ListCollaboratorsResultSet(result);
	}
