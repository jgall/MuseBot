package com.temboo.Library.Google.ComputeEngine.GlobalOperations;
...
*/
public  class DeleteGlobalOperationResultSet extends ResultSet {
		
	public DeleteGlobalOperationResultSet(JSONObject doc) {
		super(doc);
	}
