...
*/
public class GetFoodUnits extends Choreography {

	/**
	Create a new instance of the GetFoodUnits Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public GetFoodUnits(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Fitbit/Foods/GetFoodUnits"));
	}
	...
	*/
	 ...
	 */
	@Override
	public GetFoodUnitsResultSet run() {
		JSONObject result = super.runWithResults();
		return new GetFoodUnitsResultSet(result);
	}
