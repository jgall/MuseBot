...
*/
public class GetFriendsLeaderboard extends Choreography {

	/**
	Create a new instance of the GetFriendsLeaderboard Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public GetFriendsLeaderboard(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Fitbit/Social/GetFriendsLeaderboard"));
	}
	...
	*/
	 ...
	 */
	@Override
	public GetFriendsLeaderboardResultSet run() {
		JSONObject result = super.runWithResults();
		return new GetFriendsLeaderboardResultSet(result);
	}
