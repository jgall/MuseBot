...
*/
public class GetGlucose extends Choreography {

	/**
	Create a new instance of the GetGlucose Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public GetGlucose(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Fitbit/Glucose/GetGlucose"));
	}
	...
	*/
	 ...
	 */
	@Override
	public GetGlucoseResultSet run() {
		JSONObject result = super.runWithResults();
		return new GetGlucoseResultSet(result);
	}
