...
*/
public class GetFoods extends Choreography {

	/**
	Create a new instance of the GetFoods Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public GetFoods(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Fitbit/Foods/GetFoods"));
	}
	...
	*/
	 ...
	 */
	@Override
	public GetFoodsResultSet run() {
		JSONObject result = super.runWithResults();
		return new GetFoodsResultSet(result);
	}
