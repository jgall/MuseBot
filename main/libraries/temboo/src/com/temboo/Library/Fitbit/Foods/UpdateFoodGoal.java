...
*/
public class UpdateFoodGoal extends Choreography {

	/**
	Create a new instance of the UpdateFoodGoal Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public UpdateFoodGoal(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Fitbit/Foods/UpdateFoodGoal"));
	}
	...
	*/
	...
	@param String - (conditional, integer) The calorie consumption goal; either calories or intensity should be provided.
	*/
	...
	*/
	public void setIntensity(String value) {
		this.inputs.setInput("Intensity", value);
	}
	...
	*/
	public void setPersonalized(Boolean value) {
		this.inputs.setInput("Personalized", value);
	}

	/** 
	Set the value of the Personalized input for this Choreo as a String. 

	@param String - (optional, boolean) Food Plan type; true or false.
	*/
	...
	*/
	 ...
	 */
	@Override
	public UpdateFoodGoalResultSet run() {
		JSONObject result = super.runWithResults();
		return new UpdateFoodGoalResultSet(result);
	}
