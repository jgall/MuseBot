...
*/
public class DeleteBloodPressureLog extends Choreography {

	/**
	Create a new instance of the DeleteBloodPressureLog Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public DeleteBloodPressureLog(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Fitbit/BloodPressure/DeleteBloodPressureLog"));
	}
	...
	*/
	public void setBloodPressureLogID(Integer value) {
		this.inputs.setInput("BloodPressureLogID", value);
	}

	/** 
	Set the value of the BloodPressureLogID input for this Choreo as a String. 

	@param String - (required, integer) The id of the blood pressure log you want to delete.
	*/
	public void setBloodPressureLogID(String value) {
		this.inputs.setInput("BloodPressureLogID", value);	
	}
	/** 
	...
	*/
	 ...
	 */
	@Override
	public DeleteBloodPressureLogResultSet run() {
		JSONObject result = super.runWithResults();
		return new DeleteBloodPressureLogResultSet(result);
	}
