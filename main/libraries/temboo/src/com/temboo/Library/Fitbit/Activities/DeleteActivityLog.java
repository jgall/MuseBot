...
*/
public class DeleteActivityLog extends Choreography {

	/**
	Create a new instance of the DeleteActivityLog Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public DeleteActivityLog(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Fitbit/Activities/DeleteActivityLog"));
	}
	...
	*/
	public void setActivityLogID(Integer value) {
		this.inputs.setInput("ActivityLogID", value);
	}

	/** 
	Set the value of the ActivityLogID input for this Choreo as a String. 

	@param String - (required, integer) The id of the activity log you want to delete. The Id is returned in the LogActivity response.
	*/
	...
	*/
	 ...
	 */
	@Override
	public DeleteActivityLogResultSet run() {
		JSONObject result = super.runWithResults();
		return new DeleteActivityLogResultSet(result);
	}
