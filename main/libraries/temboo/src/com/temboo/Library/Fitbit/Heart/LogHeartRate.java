...
*/
public class LogHeartRate extends Choreography {

	/**
	Create a new instance of the LogHeartRate Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public LogHeartRate(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Fitbit/Heart/LogHeartRate"));
	}
	...
	*/
	public void setHeartRate(Integer value) {
		this.inputs.setInput("HeartRate", value);
	}

	/** 
	Set the value of the HeartRate input for this Choreo as a String. 

	@param String - (required, integer) Heart rate measurement.
	*/
	...
	*/
	 ...
	 */
	@Override
	public LogHeartRateResultSet run() {
		JSONObject result = super.runWithResults();
		return new LogHeartRateResultSet(result);
	}
