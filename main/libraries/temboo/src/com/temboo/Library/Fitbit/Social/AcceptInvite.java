...
*/
public class AcceptInvite extends Choreography {

	/**
	Create a new instance of the AcceptInvite Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public AcceptInvite(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Fitbit/Social/AcceptInvite"));
	}
	...
	*/
	public void setAccept(Boolean value) {
		this.inputs.setInput("Accept", value);
	}

	/** 
	Set the value of the Accept input for this Choreo as a String. 

	@param String - (required, boolean) Accept or reject an invite; (true or false).
	*/
	...
	*/
	public void setFromUserID(String value) {
		this.inputs.setInput("FromUserID", value);
	}
	...
	*/
	 ...
	 */
	@Override
	public AcceptInviteResultSet run() {
		JSONObject result = super.runWithResults();
		return new AcceptInviteResultSet(result);
	}
