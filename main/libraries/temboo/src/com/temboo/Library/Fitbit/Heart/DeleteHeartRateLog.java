package com.temboo.Library.Fitbit.Heart;
...
*/
public class DeleteHeartRateLog extends Choreography {

	/**
	Create a new instance of the DeleteHeartRateLog Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public DeleteHeartRateLog(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Fitbit/Heart/DeleteHeartRateLog"));
	}
	...
	*/
	public void setHeartRateLogID(Integer value) {
		this.inputs.setInput("HeartRateLogID", value);
	}

	/** 
	Set the value of the HeartRateLogID input for this Choreo as a String. 

	@param String - (required, integer) The id of the heart rate log you want to delete.
	*/
	public void setHeartRateLogID(String value) {
		this.inputs.setInput("HeartRateLogID", value);	
	}
	/** 
	...
	*/
	 ...
	 */
	@Override
	public DeleteHeartRateLogResultSet run() {
		JSONObject result = super.runWithResults();
		return new DeleteHeartRateLogResultSet(result);
	}
