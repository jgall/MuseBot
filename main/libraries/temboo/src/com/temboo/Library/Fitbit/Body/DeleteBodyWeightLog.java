...
*/
public class DeleteBodyWeightLog extends Choreography {

	/**
	Create a new instance of the DeleteBodyWeightLog Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public DeleteBodyWeightLog(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Fitbit/Body/DeleteBodyWeightLog"));
	}
	...
	*/
	public void setBodyWeightLogID(Integer value) {
		this.inputs.setInput("BodyWeightLogID", value);
	}

	/** 
	Set the value of the BodyWeightLogID input for this Choreo as a String. 

	@param String - (required, integer) The id of the body weight log entry.
	*/
	...
	*/
	 ...
	 */
	@Override
	public DeleteBodyWeightLogResultSet run() {
		JSONObject result = super.runWithResults();
		return new DeleteBodyWeightLogResultSet(result);
	}
