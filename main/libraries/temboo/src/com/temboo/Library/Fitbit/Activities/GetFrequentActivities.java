...
*/
public class GetFrequentActivities extends Choreography {

	/**
	Create a new instance of the GetFrequentActivities Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public GetFrequentActivities(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Fitbit/Activities/GetFrequentActivities"));
	}
	...
	*/
	 ...
	 */
	@Override
	public GetFrequentActivitiesResultSet run() {
		JSONObject result = super.runWithResults();
		return new GetFrequentActivitiesResultSet(result);
	}
