...
*/
public class DeleteFoodLog extends Choreography {

	/**
	Create a new instance of the DeleteFoodLog Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public DeleteFoodLog(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Fitbit/Foods/DeleteFoodLog"));
	}
	...
	*/
	public void setFoodLogID(Integer value) {
		this.inputs.setInput("FoodLogID", value);
	}

	/** 
	Set the value of the FoodLogID input for this Choreo as a String. 

	@param String - (required, integer) The id of the food log you want to delete. The Id is returned in the LogFood response.
	*/
	...
	*/
	 ...
	 */
	@Override
	public DeleteFoodLogResultSet run() {
		JSONObject result = super.runWithResults();
		return new DeleteFoodLogResultSet(result);
	}
