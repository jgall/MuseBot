...
*/
public class GetActivityStats extends Choreography {

	/**
	Create a new instance of the GetActivityStats Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public GetActivityStats(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Fitbit/Statistics/GetActivityStats"));
	}
	...
	*/
	 ...
	 */
	@Override
	public GetActivityStatsResultSet run() {
		JSONObject result = super.runWithResults();
		return new GetActivityStatsResultSet(result);
	}
