...
*/
public class GetFoodGoal extends Choreography {

	/**
	Create a new instance of the GetFoodGoal Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public GetFoodGoal(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Fitbit/Foods/GetFoodGoal"));
	}
	...
	*/
	 ...
	 */
	@Override
	public GetFoodGoalResultSet run() {
		JSONObject result = super.runWithResults();
		return new GetFoodGoalResultSet(result);
	}
