...
*/
public class GetDevices extends Choreography {

	/**
	Create a new instance of the GetDevices Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public GetDevices(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Fitbit/Devices/GetDevices"));
	}
	...
	*/
	 ...
	 */
	@Override
	public GetDevicesResultSet run() {
		JSONObject result = super.runWithResults();
		return new GetDevicesResultSet(result);
	}
