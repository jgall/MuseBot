...
*/
public class GetRecentFoods extends Choreography {

	/**
	Create a new instance of the GetRecentFoods Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public GetRecentFoods(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Fitbit/Foods/GetRecentFoods"));
	}
	...
	*/
	 ...
	 */
	@Override
	public GetRecentFoodsResultSet run() {
		JSONObject result = super.runWithResults();
		return new GetRecentFoodsResultSet(result);
	}
