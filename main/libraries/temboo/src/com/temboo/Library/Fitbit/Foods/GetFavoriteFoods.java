...
*/
public class GetFavoriteFoods extends Choreography {

	/**
	Create a new instance of the GetFavoriteFoods Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public GetFavoriteFoods(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Fitbit/Foods/GetFavoriteFoods"));
	}
	...
	*/
	 ...
	 */
	@Override
	public GetFavoriteFoodsResultSet run() {
		JSONObject result = super.runWithResults();
		return new GetFavoriteFoodsResultSet(result);
	}
