...
*/
public class GetBodyFatGoal extends Choreography {

	/**
	Create a new instance of the GetBodyFatGoal Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public GetBodyFatGoal(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Fitbit/Body/GetBodyFatGoal"));
	}
	...
	*/
	 ...
	 */
	@Override
	public GetBodyFatGoalResultSet run() {
		JSONObject result = super.runWithResults();
		return new GetBodyFatGoalResultSet(result);
	}
