...
*/
public class GetBodyMeasurements extends Choreography {

	/**
	Create a new instance of the GetBodyMeasurements Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public GetBodyMeasurements(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Fitbit/Body/GetBodyMeasurements"));
	}
	...
	*/
	 ...
	 */
	@Override
	public GetBodyMeasurementsResultSet run() {
		JSONObject result = super.runWithResults();
		return new GetBodyMeasurementsResultSet(result);
	}
