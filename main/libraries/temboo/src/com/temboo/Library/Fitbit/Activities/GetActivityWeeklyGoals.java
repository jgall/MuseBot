...
*/
public class GetActivityWeeklyGoals extends Choreography {

	/**
	Create a new instance of the GetActivityWeeklyGoals Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public GetActivityWeeklyGoals(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Fitbit/Activities/GetActivityWeeklyGoals"));
	}
	...
	*/
	 ...
	 */
	@Override
	public GetActivityWeeklyGoalsResultSet run() {
		JSONObject result = super.runWithResults();
		return new GetActivityWeeklyGoalsResultSet(result);
	}
