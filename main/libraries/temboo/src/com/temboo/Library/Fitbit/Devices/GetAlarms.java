...
*/
public class GetAlarms extends Choreography {

	/**
	Create a new instance of the GetAlarms Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public GetAlarms(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Fitbit/Devices/GetAlarms"));
	}
	...
	*/
	 ...
	 */
	@Override
	public GetAlarmsResultSet run() {
		JSONObject result = super.runWithResults();
		return new GetAlarmsResultSet(result);
	}
