...
*/
public class GetFavoriteActivities extends Choreography {

	/**
	Create a new instance of the GetFavoriteActivities Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public GetFavoriteActivities(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Fitbit/Activities/GetFavoriteActivities"));
	}
	...
	*/
	 ...
	 */
	@Override
	public GetFavoriteActivitiesResultSet run() {
		JSONObject result = super.runWithResults();
		return new GetFavoriteActivitiesResultSet(result);
	}
