...
*/
public class GetBodyWeight extends Choreography {

	/**
	Create a new instance of the GetBodyWeight Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public GetBodyWeight(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Fitbit/Body/GetBodyWeight"));
	}
	...
	*/
	 ...
	 */
	@Override
	public GetBodyWeightResultSet run() {
		JSONObject result = super.runWithResults();
		return new GetBodyWeightResultSet(result);
	}
