...
*/
public class AddFavoriteFood extends Choreography {

	/**
	Create a new instance of the AddFavoriteFood Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public AddFavoriteFood(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Fitbit/Foods/AddFavoriteFood"));
	}
	...
	*/
	...
	@param String - (required, integer) The id of the food you want to make a favorite.
	*/
	...
	*/
	 ...
	 */
	@Override
	public AddFavoriteFoodResultSet run() {
		JSONObject result = super.runWithResults();
		return new AddFavoriteFoodResultSet(result);
	}
