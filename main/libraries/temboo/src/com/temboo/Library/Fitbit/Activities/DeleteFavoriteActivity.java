...
*/
public class DeleteFavoriteActivity extends Choreography {

	/**
	Create a new instance of the DeleteFavoriteActivity Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public DeleteFavoriteActivity(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Fitbit/Activities/DeleteFavoriteActivity"));
	}
	...
	*/
	...
	@param String - (required, integer) The id of the activity you want to delete from your favorites list.
	*/
	...
	*/
	 ...
	 */
	@Override
	public DeleteFavoriteActivityResultSet run() {
		JSONObject result = super.runWithResults();
		return new DeleteFavoriteActivityResultSet(result);
	}
