...
*/
public class GetActivities extends Choreography {

	/**
	Create a new instance of the GetActivities Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public GetActivities(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Fitbit/Activities/GetActivities"));
	}
	...
	*/
	 ...
	 */
	@Override
	public GetActivitiesResultSet run() {
		JSONObject result = super.runWithResults();
		return new GetActivitiesResultSet(result);
	}
