...
*/
public class GetBodyWeightGoal extends Choreography {

	/**
	Create a new instance of the GetBodyWeightGoal Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public GetBodyWeightGoal(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Fitbit/Body/GetBodyWeightGoal"));
	}
	...
	*/
	 ...
	 */
	@Override
	public GetBodyWeightGoalResultSet run() {
		JSONObject result = super.runWithResults();
		return new GetBodyWeightGoalResultSet(result);
	}
