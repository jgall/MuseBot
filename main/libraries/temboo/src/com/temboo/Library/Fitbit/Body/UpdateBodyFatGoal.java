...
*/
public class UpdateBodyFatGoal extends Choreography {

	/**
	Create a new instance of the UpdateBodyFatGoal Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public UpdateBodyFatGoal(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Fitbit/Body/UpdateBodyFatGoal"));
	}
	...
	*/
	...
	@param String - (required, decimal) Target body fat in %;  Fitbit currently only accepts whole numbers.
	*/
	...
	*/
	 ...
	 */
	@Override
	public UpdateBodyFatGoalResultSet run() {
		JSONObject result = super.runWithResults();
		return new UpdateBodyFatGoalResultSet(result);
	}
