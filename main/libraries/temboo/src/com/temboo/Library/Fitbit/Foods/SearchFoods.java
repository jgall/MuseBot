...
*/
public class SearchFoods extends Choreography {

	/**
	Create a new instance of the SearchFoods Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public SearchFoods(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Fitbit/Foods/SearchFoods"));
	}
	...
	*/
	 ...
	 */
	@Override
	public SearchFoodsResultSet run() {
		JSONObject result = super.runWithResults();
		return new SearchFoodsResultSet(result);
	}
