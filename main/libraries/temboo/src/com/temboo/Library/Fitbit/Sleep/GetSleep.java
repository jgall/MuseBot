...
*/
public class GetSleep extends Choreography {

	/**
	Create a new instance of the GetSleep Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public GetSleep(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Fitbit/Sleep/GetSleep"));
	}
	...
	*/
	 ...
	 */
	@Override
	public GetSleepResultSet run() {
		JSONObject result = super.runWithResults();
		return new GetSleepResultSet(result);
	}
