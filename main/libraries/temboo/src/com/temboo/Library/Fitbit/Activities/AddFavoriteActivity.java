...
*/
public class AddFavoriteActivity extends Choreography {

	/**
	Create a new instance of the AddFavoriteActivity Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public AddFavoriteActivity(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Fitbit/Activities/AddFavoriteActivity"));
	}
	...
	*/
	...
	@param String - (required, integer) The id of the activity you want to make a favorite.
	*/
	...
	*/
	 ...
	 */
	@Override
	public AddFavoriteActivityResultSet run() {
		JSONObject result = super.runWithResults();
		return new AddFavoriteActivityResultSet(result);
	}
