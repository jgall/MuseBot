...
*/
public class GetWaterGoal extends Choreography {

	/**
	Create a new instance of the GetWaterGoal Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public GetWaterGoal(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Fitbit/Foods/GetWaterGoal"));
	}
	...
	*/
	 ...
	 */
	@Override
	public GetWaterGoalResultSet run() {
		JSONObject result = super.runWithResults();
		return new GetWaterGoalResultSet(result);
	}
