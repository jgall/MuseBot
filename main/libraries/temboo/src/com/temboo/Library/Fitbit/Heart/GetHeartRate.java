...
*/
public class GetHeartRate extends Choreography {

	/**
	Create a new instance of the GetHeartRate Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public GetHeartRate(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Fitbit/Heart/GetHeartRate"));
	}
	...
	*/
	 ...
	 */
	@Override
	public GetHeartRateResultSet run() {
		JSONObject result = super.runWithResults();
		return new GetHeartRateResultSet(result);
	}
