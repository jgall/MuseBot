...
*/
public class GetBloodPressure extends Choreography {

	/**
	Create a new instance of the GetBloodPressure Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public GetBloodPressure(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Fitbit/BloodPressure/GetBloodPressure"));
	}
	...
	*/
	 ...
	 */
	@Override
	public GetBloodPressureResultSet run() {
		JSONObject result = super.runWithResults();
		return new GetBloodPressureResultSet(result);
	}
