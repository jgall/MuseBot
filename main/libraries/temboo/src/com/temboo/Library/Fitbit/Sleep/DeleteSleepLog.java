...
*/
public class DeleteSleepLog extends Choreography {

	/**
	Create a new instance of the DeleteSleepLog Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public DeleteSleepLog(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Fitbit/Sleep/DeleteSleepLog"));
	}
	...
	*/
	public void setSleepLogID(Integer value) {
		this.inputs.setInput("SleepLogID", value);
	}

	/** 
	Set the value of the SleepLogID input for this Choreo as a String. 

	@param String - (required, integer) The id of the sleep log you want to delete.
	*/
	...
	*/
	 ...
	 */
	@Override
	public DeleteSleepLogResultSet run() {
		JSONObject result = super.runWithResults();
		return new DeleteSleepLogResultSet(result);
	}
