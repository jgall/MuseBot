...
*/
public class GetRecentActivities extends Choreography {

	/**
	Create a new instance of the GetRecentActivities Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public GetRecentActivities(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Fitbit/Activities/GetRecentActivities"));
	}
	...
	*/
	 ...
	 */
	@Override
	public GetRecentActivitiesResultSet run() {
		JSONObject result = super.runWithResults();
		return new GetRecentActivitiesResultSet(result);
	}
