...
*/
public class DeleteBodyFatLog extends Choreography {

	/**
	Create a new instance of the DeleteBodyFatLog Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public DeleteBodyFatLog(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Fitbit/Body/DeleteBodyFatLog"));
	}
	...
	*/
	public void setBodyFatLogID(Integer value) {
		this.inputs.setInput("BodyFatLogID", value);
	}

	/** 
	Set the value of the BodyFatLogID input for this Choreo as a String. 

	@param String - (required, integer) The id of the body fat log entry.
	*/
	...
	*/
	 ...
	 */
	@Override
	public DeleteBodyFatLogResultSet run() {
		JSONObject result = super.runWithResults();
		return new DeleteBodyFatLogResultSet(result);
	}
