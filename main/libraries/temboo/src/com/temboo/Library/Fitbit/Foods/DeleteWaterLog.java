...
*/
public class DeleteWaterLog extends Choreography {

	/**
	Create a new instance of the DeleteWaterLog Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public DeleteWaterLog(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Fitbit/Foods/DeleteWaterLog"));
	}
	...
	*/
	public void setWaterLogID(Integer value) {
		this.inputs.setInput("WaterLogID", value);
	}

	/** 
	Set the value of the WaterLogID input for this Choreo as a String. 

	@param String - (required, integer) The id of the water log you want to delete. The Id is returned in the LogWater response.
	*/
	 ...
	 */
	@Override
	public DeleteWaterLogResultSet run() {
		JSONObject result = super.runWithResults();
		return new DeleteWaterLogResultSet(result);
	}
