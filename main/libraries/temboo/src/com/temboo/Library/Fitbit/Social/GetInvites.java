...
*/
public class GetInvites extends Choreography {

	/**
	Create a new instance of the GetInvites Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public GetInvites(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Fitbit/Social/GetInvites"));
	}
	...
	*/
	 ...
	 */
	@Override
	public GetInvitesResultSet run() {
		JSONObject result = super.runWithResults();
		return new GetInvitesResultSet(result);
	}
