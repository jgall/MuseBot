...
*/
public class LogBodyWeight extends Choreography {

	/**
	Create a new instance of the LogBodyWeight Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public LogBodyWeight(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Fitbit/Body/LogBodyWeight"));
	}
	...
	*/
	...
	@param String - (required, decimal) A new value (in pounds) to log for weight. In the format of X.XX.
	*/
	 ...
	 */
	@Override
	public LogBodyWeightResultSet run() {
		JSONObject result = super.runWithResults();
		return new LogBodyWeightResultSet(result);
	}
