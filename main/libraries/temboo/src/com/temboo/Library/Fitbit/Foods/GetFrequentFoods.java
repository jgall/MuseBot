...
*/
public class GetFrequentFoods extends Choreography {

	/**
	Create a new instance of the GetFrequentFoods Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public GetFrequentFoods(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Fitbit/Foods/GetFrequentFoods"));
	}
	...
	*/
	 ...
	 */
	@Override
	public GetFrequentFoodsResultSet run() {
		JSONObject result = super.runWithResults();
		return new GetFrequentFoodsResultSet(result);
	}
