...
*/
public class GetMeals extends Choreography {

	/**
	Create a new instance of the GetMeals Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public GetMeals(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Fitbit/Foods/GetMeals"));
	}
	...
	*/
	 ...
	 */
	@Override
	public GetMealsResultSet run() {
		JSONObject result = super.runWithResults();
		return new GetMealsResultSet(result);
	}
