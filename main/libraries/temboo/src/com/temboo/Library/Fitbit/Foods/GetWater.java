...
*/
public class GetWater extends Choreography {

	/**
	Create a new instance of the GetWater Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public GetWater(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Fitbit/Foods/GetWater"));
	}
	...
	*/
	 ...
	 */
	@Override
	public GetWaterResultSet run() {
		JSONObject result = super.runWithResults();
		return new GetWaterResultSet(result);
	}
