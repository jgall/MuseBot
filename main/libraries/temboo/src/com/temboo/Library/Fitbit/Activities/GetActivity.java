...
public class GetActivity extends Choreography {
	...
	*/
	public GetActivity(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Fitbit/Activities/GetActivity"));
	}
	...
	*/
	...
	@param Integer - (required, integer) The ID of the activity to retrieve.
	*/
	...
	@param String - (required, integer) The ID of the activity to retrieve.
	*/
