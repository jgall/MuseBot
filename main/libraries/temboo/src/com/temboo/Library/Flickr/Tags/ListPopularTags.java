...
*/
public class ListPopularTags extends Choreography {

	/**
	Create a new instance of the ListPopularTags Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public ListPopularTags(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Flickr/Tags/ListPopularTags"));
	}
	...
	*/
	...
	@param String - (optional, integer) Number of popular tags to return. defaults to 10 when this argument is not present.
	*/
	...
	*/
	 ...
	 */
	@Override
	public ListPopularTagsResultSet run() {
		JSONObject result = super.runWithResults();
		return new ListPopularTagsResultSet(result);
	}
