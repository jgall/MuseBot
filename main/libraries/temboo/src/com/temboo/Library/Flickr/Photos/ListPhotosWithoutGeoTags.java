...
*/
public class ListPhotosWithoutGeoTags extends Choreography {

	/**
	Create a new instance of the ListPhotosWithoutGeoTags Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public ListPhotosWithoutGeoTags(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Flickr/Photos/ListPhotosWithoutGeoTags"));
	}
	...
	*/
	 ...
	 */
	@Override
	public ListPhotosWithoutGeoTagsResultSet run() {
		JSONObject result = super.runWithResults();
		return new ListPhotosWithoutGeoTagsResultSet(result);
	}
