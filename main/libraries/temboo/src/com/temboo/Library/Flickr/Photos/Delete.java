...
public class Delete extends Choreography {
	...
	*/
	public Delete(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Flickr/Photos/Delete"));
	}
	...
	*/
	...
	@param String - (required, integer) The id of the photo that you want to delete.
	*/
