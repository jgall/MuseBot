package com.temboo.Library.Flickr.PhotoComments;
...
*/
public class RemoveComment extends Choreography {

	/**
	Create a new instance of the RemoveComment Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public RemoveComment(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Flickr/PhotoComments/RemoveComment"));
	}
	...
	*/
	 ...
	 */
	@Override
	public RemoveCommentResultSet run() {
		JSONObject result = super.runWithResults();
		return new RemoveCommentResultSet(result);
	}
