...
public class ListComments extends Choreography {
	...
	*/
	public ListComments(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Flickr/PhotoComments/ListComments"));
	}
	...
	*/
	public void setMaxCommentDate(String value) {
		this.inputs.setInput("MaxCommentDate", value);
	}
	...
	*/
	public void setMinCommentDate(String value) {
		this.inputs.setInput("MinCommentDate", value);
	}
	...
	*/
	...
	@param String - (required, integer) The id of the photo to retrieve comments for.
	*/
