...
*/
public class AddToFavorites extends Choreography {

	/**
	Create a new instance of the AddToFavorites Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public AddToFavorites(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Flickr/Favorites/AddToFavorites"));
	}
	...
	*/
	...
	@param String - (required, integer) The id of the photo to add a favorites list.
	*/
	...
	*/
	 ...
	 */
	@Override
	public AddToFavoritesResultSet run() {
		JSONObject result = super.runWithResults();
		return new AddToFavoritesResultSet(result);
	}
