...
public class LeaveComment extends Choreography {
	...
	*/
	public LeaveComment(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Flickr/PhotoComments/LeaveComment"));
	}
	...
	*/
	...
	@param String - (required, integer) The id of the photo to add a comment to
	*/
