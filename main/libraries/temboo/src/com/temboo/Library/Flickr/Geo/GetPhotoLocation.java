...
*/
public class GetPhotoLocation extends Choreography {

	/**
	Create a new instance of the GetPhotoLocation Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public GetPhotoLocation(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Flickr/Geo/GetPhotoLocation"));
	}
	...
	*/
	...
	@param String - (required, integer) The id of the photo that you want to get the location for.
	*/
	...
	*/
	 ...
	 */
	@Override
	public GetPhotoLocationResultSet run() {
		JSONObject result = super.runWithResults();
		return new GetPhotoLocationResultSet(result);
	}
