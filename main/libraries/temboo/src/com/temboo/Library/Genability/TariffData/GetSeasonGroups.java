...
*/
public class GetSeasonGroups extends Choreography {

	/**
	Create a new instance of the GetSeasonGroups Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public GetSeasonGroups(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Genability/TariffData/GetSeasonGroups"));
	}
	...
	*/
	...
	@param String - (required, integer) The LSE Id whose Seasons to return.
	*/
	...
	*/
	 ...
	 */
	@Override
	public GetSeasonGroupsResultSet run() {
		JSONObject result = super.runWithResults();
		return new GetSeasonGroupsResultSet(result);
	}
