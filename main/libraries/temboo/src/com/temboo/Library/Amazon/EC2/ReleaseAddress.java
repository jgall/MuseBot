...
*/
public class ReleaseAddress extends Choreography {

	/**
	Create a new instance of the ReleaseAddress Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public ReleaseAddress(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Amazon/EC2/ReleaseAddress"));
	}
	...
	*/
	 ...
	 */
	@Override
	public ReleaseAddressResultSet run() {
		JSONObject result = super.runWithResults();
		return new ReleaseAddressResultSet(result);
	}
