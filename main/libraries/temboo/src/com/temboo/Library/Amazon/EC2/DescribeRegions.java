...
*/
public class DescribeRegions extends Choreography {

	/**
	Create a new instance of the DescribeRegions Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public DescribeRegions(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Amazon/EC2/DescribeRegions"));
	}
	...
	*/
	public void setRegionName(String value) {
		this.inputs.setInput("RegionName", value);
	}
	...
	*/
	 ...
	 */
	@Override
	public DescribeRegionsResultSet run() {
		JSONObject result = super.runWithResults();
		return new DescribeRegionsResultSet(result);
	}
