...
*/
public class DescribeVolumes extends Choreography {

	/**
	Create a new instance of the DescribeVolumes Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public DescribeVolumes(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Amazon/EC2/DescribeVolumes"));
	}
	...
	*/
	 ...
	 */
	@Override
	public DescribeVolumesResultSet run() {
		JSONObject result = super.runWithResults();
		return new DescribeVolumesResultSet(result);
	}
