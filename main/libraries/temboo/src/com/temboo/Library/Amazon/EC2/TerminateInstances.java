...
*/
public class TerminateInstances extends Choreography {

	/**
	Create a new instance of the TerminateInstances Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public TerminateInstances(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Amazon/EC2/TerminateInstances"));
	}
	...
	*/
	 ...
	 */
	@Override
	public TerminateInstancesResultSet run() {
		JSONObject result = super.runWithResults();
		return new TerminateInstancesResultSet(result);
	}
