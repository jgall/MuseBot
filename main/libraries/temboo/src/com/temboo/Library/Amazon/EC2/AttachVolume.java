...
*/
public class AttachVolume extends Choreography {

	/**
	Create a new instance of the AttachVolume Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public AttachVolume(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Amazon/EC2/AttachVolume"));
	}
	...
	*/
	 ...
	 */
	@Override
	public AttachVolumeResultSet run() {
		JSONObject result = super.runWithResults();
		return new AttachVolumeResultSet(result);
	}
