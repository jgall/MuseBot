...
*/
public class DeleteBucketTagging extends Choreography {

	/**
	Create a new instance of the DeleteBucketTagging Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public DeleteBucketTagging(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Amazon/S3/DeleteBucketTagging"));
	}
	...
	*/
	 ...
	 */
	@Override
	public DeleteBucketTaggingResultSet run() {
		JSONObject result = super.runWithResults();
		return new DeleteBucketTaggingResultSet(result);
	}
