...
*/
public class GetBucketLogging extends Choreography {

	/**
	Create a new instance of the GetBucketLogging Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public GetBucketLogging(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Amazon/S3/GetBucketLogging"));
	}
	...
	*/
	 ...
	 */
	@Override
	public GetBucketLoggingResultSet run() {
		JSONObject result = super.runWithResults();
		return new GetBucketLoggingResultSet(result);
	}
