...
*/
public class GetBucketPolicy extends Choreography {

	/**
	Create a new instance of the GetBucketPolicy Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public GetBucketPolicy(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Amazon/S3/GetBucketPolicy"));
	}
	...
	*/
	 ...
	 */
	@Override
	public GetBucketPolicyResultSet run() {
		JSONObject result = super.runWithResults();
		return new GetBucketPolicyResultSet(result);
	}
