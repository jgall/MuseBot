...
*/
public class GetLowestOfferListingsForASIN extends Choreography {

	/**
	Create a new instance of the GetLowestOfferListingsForASIN Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public GetLowestOfferListingsForASIN(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Amazon/Marketplace/Products/GetLowestOfferListingsForASIN"));
	}
	...
	*/
	 ...
	 */
	@Override
	public GetLowestOfferListingsForASINResultSet run() {
		JSONObject result = super.runWithResults();
		return new GetLowestOfferListingsForASINResultSet(result);
	}
