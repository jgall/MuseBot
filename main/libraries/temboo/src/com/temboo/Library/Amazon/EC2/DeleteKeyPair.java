...
*/
public class DeleteKeyPair extends Choreography {

	/**
	Create a new instance of the DeleteKeyPair Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public DeleteKeyPair(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Amazon/EC2/DeleteKeyPair"));
	}
	...
	*/
	 ...
	 */
	@Override
	public DeleteKeyPairResultSet run() {
		JSONObject result = super.runWithResults();
		return new DeleteKeyPairResultSet(result);
	}
