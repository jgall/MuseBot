...
*/
public class GetBucketCORS extends Choreography {

	/**
	Create a new instance of the GetBucketCORS Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public GetBucketCORS(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Amazon/S3/GetBucketCORS"));
	}
	...
	*/
	 ...
	 */
	@Override
	public GetBucketCORSResultSet run() {
		JSONObject result = super.runWithResults();
		return new GetBucketCORSResultSet(result);
	}
