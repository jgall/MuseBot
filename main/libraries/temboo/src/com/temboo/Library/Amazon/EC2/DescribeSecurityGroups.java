...
*/
public class DescribeSecurityGroups extends Choreography {

	/**
	Create a new instance of the DescribeSecurityGroups Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public DescribeSecurityGroups(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Amazon/EC2/DescribeSecurityGroups"));
	}
	...
	*/
	 ...
	 */
	@Override
	public DescribeSecurityGroupsResultSet run() {
		JSONObject result = super.runWithResults();
		return new DescribeSecurityGroupsResultSet(result);
	}
