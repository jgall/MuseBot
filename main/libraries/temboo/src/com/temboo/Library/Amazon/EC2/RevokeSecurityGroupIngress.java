...
public class RevokeSecurityGroupIngress extends Choreography {
	...
	*/
	public RevokeSecurityGroupIngress(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Amazon/EC2/RevokeSecurityGroupIngress"));
	}
	...
	*/
	 ...
	 */
	@Override
	public RevokeSecurityGroupIngressResultSet run() {
		JSONObject result = super.runWithResults();
		return new RevokeSecurityGroupIngressResultSet(result);
	}
