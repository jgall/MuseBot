...
*/
public class DeleteVolume extends Choreography {

	/**
	Create a new instance of the DeleteVolume Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public DeleteVolume(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Amazon/EC2/DeleteVolume"));
	}
	...
	*/
	 ...
	 */
	@Override
	public DeleteVolumeResultSet run() {
		JSONObject result = super.runWithResults();
		return new DeleteVolumeResultSet(result);
	}
