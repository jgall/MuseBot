...
*/
public class PutBucketPolicy extends Choreography {

	/**
	Create a new instance of the PutBucketPolicy Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public PutBucketPolicy(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Amazon/S3/PutBucketPolicy"));
	}
	...
	*/
	 ...
	 */
	@Override
	public PutBucketPolicyResultSet run() {
		JSONObject result = super.runWithResults();
		return new PutBucketPolicyResultSet(result);
	}
