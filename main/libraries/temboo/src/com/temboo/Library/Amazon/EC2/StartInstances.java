...
*/
public class StartInstances extends Choreography {

	/**
	Create a new instance of the StartInstances Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public StartInstances(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Amazon/EC2/StartInstances"));
	}
	...
	*/
	 ...
	 */
	@Override
	public StartInstancesResultSet run() {
		JSONObject result = super.runWithResults();
		return new StartInstancesResultSet(result);
	}
