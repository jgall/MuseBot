...
*/
public class GetOrder extends Choreography {

	/**
	Create a new instance of the GetOrder Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public GetOrder(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Amazon/Marketplace/Orders/GetOrder"));
	}
	...
	*/
	...
	@param String - (required, string) One or more AmazonOrderId values separated by commas used to retrieve orders.
	*/
	...
	*/
	 ...
	 */
	@Override
	public GetOrderResultSet run() {
		JSONObject result = super.runWithResults();
		return new GetOrderResultSet(result);
	}
