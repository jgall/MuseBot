...
*/
public class GetBucketLifecycle extends Choreography {

	/**
	Create a new instance of the GetBucketLifecycle Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public GetBucketLifecycle(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Amazon/S3/GetBucketLifecycle"));
	}
	...
	*/
	 ...
	 */
	@Override
	public GetBucketLifecycleResultSet run() {
		JSONObject result = super.runWithResults();
		return new GetBucketLifecycleResultSet(result);
	}
