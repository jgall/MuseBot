...
*/
public class GetBucketNotification extends Choreography {

	/**
	Create a new instance of the GetBucketNotification Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public GetBucketNotification(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Amazon/S3/GetBucketNotification"));
	}
	...
	*/
	 ...
	 */
	@Override
	public GetBucketNotificationResultSet run() {
		JSONObject result = super.runWithResults();
		return new GetBucketNotificationResultSet(result);
	}
