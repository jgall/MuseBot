...
*/
public class SubmitFeed extends Choreography {

	/**
	Create a new instance of the SubmitFeed Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public SubmitFeed(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Amazon/Marketplace/Feeds/SubmitFeed"));
	}
	...
	*/
	 ...
	 */
	@Override
	public SubmitFeedResultSet run() {
		JSONObject result = super.runWithResults();
		return new SubmitFeedResultSet(result);
	}
