...
*/
public class DescribeSnapshots extends Choreography {

	/**
	Create a new instance of the DescribeSnapshots Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public DescribeSnapshots(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Amazon/EC2/DescribeSnapshots"));
	}
	...
	*/
	public void setRestorableBy(String value) {
		this.inputs.setInput("RestorableBy", value);
	}
	...
	*/
	 ...
	 */
	@Override
	public DescribeSnapshotsResultSet run() {
		JSONObject result = super.runWithResults();
		return new DescribeSnapshotsResultSet(result);
	}
