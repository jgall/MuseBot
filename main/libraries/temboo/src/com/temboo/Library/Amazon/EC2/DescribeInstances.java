...
*/
public class DescribeInstances extends Choreography {

	/**
	Create a new instance of the DescribeInstances Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public DescribeInstances(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Amazon/EC2/DescribeInstances"));
	}
	...
	*/
	 ...
	 */
	@Override
	public DescribeInstancesResultSet run() {
		JSONObject result = super.runWithResults();
		return new DescribeInstancesResultSet(result);
	}
