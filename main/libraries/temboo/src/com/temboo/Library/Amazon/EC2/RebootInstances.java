...
*/
public class RebootInstances extends Choreography {

	/**
	Create a new instance of the RebootInstances Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public RebootInstances(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Amazon/EC2/RebootInstances"));
	}
	...
	*/
	 ...
	 */
	@Override
	public RebootInstancesResultSet run() {
		JSONObject result = super.runWithResults();
		return new RebootInstancesResultSet(result);
	}
