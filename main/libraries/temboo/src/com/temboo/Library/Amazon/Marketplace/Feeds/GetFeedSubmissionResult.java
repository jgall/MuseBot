...
*/
public class GetFeedSubmissionResult extends Choreography {

	/**
	Create a new instance of the GetFeedSubmissionResult Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public GetFeedSubmissionResult(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Amazon/Marketplace/Feeds/GetFeedSubmissionResult"));
	}
	...
	*/
	public void setFeedSubmissionId(String value) {
		this.inputs.setInput("FeedSubmissionId", value);
	}
	 ...
	 */
	@Override
	public GetFeedSubmissionResultResultSet run() {
		JSONObject result = super.runWithResults();
		return new GetFeedSubmissionResultResultSet(result);
	}
