...
*/
public class GetServiceStatus extends Choreography {

	/**
	Create a new instance of the GetServiceStatus Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public GetServiceStatus(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Amazon/Marketplace/Products/GetServiceStatus"));
	}
	...
	*/
	 ...
	 */
	@Override
	public GetServiceStatusResultSet run() {
		JSONObject result = super.runWithResults();
		return new GetServiceStatusResultSet(result);
	}
