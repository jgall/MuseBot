...
*/
public class RetrieveReport extends Choreography {

	/**
	Create a new instance of the RetrieveReport Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public RetrieveReport(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Amazon/Marketplace/Reports/RetrieveReport"));
	}
	...
	*/
	 ...
	 */
	@Override
	public RetrieveReportResultSet run() {
		JSONObject result = super.runWithResults();
		return new RetrieveReportResultSet(result);
	}
