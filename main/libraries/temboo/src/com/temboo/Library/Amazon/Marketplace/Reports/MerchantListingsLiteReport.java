...
*/
public class MerchantListingsLiteReport extends Choreography {

	/**
	Create a new instance of the MerchantListingsLiteReport Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public MerchantListingsLiteReport(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Amazon/Marketplace/Reports/MerchantListingsLiteReport"));
	}
	...
	*/
	 ...
	 */
	@Override
	public MerchantListingsLiteReportResultSet run() {
		JSONObject result = super.runWithResults();
		return new MerchantListingsLiteReportResultSet(result);
	}
