...
*/
public class GetBucketWebsite extends Choreography {

	/**
	Create a new instance of the GetBucketWebsite Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public GetBucketWebsite(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Amazon/S3/GetBucketWebsite"));
	}
	...
	*/
	 ...
	 */
	@Override
	public GetBucketWebsiteResultSet run() {
		JSONObject result = super.runWithResults();
		return new GetBucketWebsiteResultSet(result);
	}
