...
public class PutBucketVersioning extends Choreography {
	...
	*/
	public PutBucketVersioning(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Amazon/S3/PutBucketVersioning"));
	}
	...
	*/
	 ...
	 */
	@Override
	public PutBucketVersioningResultSet run() {
		JSONObject result = super.runWithResults();
		return new PutBucketVersioningResultSet(result);
	}
