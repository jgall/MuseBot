...
*/
public class GetObjectTorrent extends Choreography {

	/**
	Create a new instance of the GetObjectTorrent Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public GetObjectTorrent(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Amazon/S3/GetObjectTorrent"));
	}
	...
	*/
	 ...
	 */
	@Override
	public GetObjectTorrentResultSet run() {
		JSONObject result = super.runWithResults();
		return new GetObjectTorrentResultSet(result);
	}
