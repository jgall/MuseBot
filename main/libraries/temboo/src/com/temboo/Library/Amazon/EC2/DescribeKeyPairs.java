...
*/
public class DescribeKeyPairs extends Choreography {

	/**
	Create a new instance of the DescribeKeyPairs Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public DescribeKeyPairs(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Amazon/EC2/DescribeKeyPairs"));
	}
	...
	*/
	 ...
	 */
	@Override
	public DescribeKeyPairsResultSet run() {
		JSONObject result = super.runWithResults();
		return new DescribeKeyPairsResultSet(result);
	}
