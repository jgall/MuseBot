...
*/
public class MonitorInstances extends Choreography {

	/**
	Create a new instance of the MonitorInstances Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public MonitorInstances(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Amazon/EC2/MonitorInstances"));
	}
	...
	*/
	 ...
	 */
	@Override
	public MonitorInstancesResultSet run() {
		JSONObject result = super.runWithResults();
		return new MonitorInstancesResultSet(result);
	}
