...
*/
public class MerchantListingsReport extends Choreography {

	/**
	Create a new instance of the MerchantListingsReport Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public MerchantListingsReport(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Amazon/Marketplace/Reports/MerchantListingsReport"));
	}
	...
	*/
	 ...
	 */
	@Override
	public MerchantListingsReportResultSet run() {
		JSONObject result = super.runWithResults();
		return new MerchantListingsReportResultSet(result);
	}
