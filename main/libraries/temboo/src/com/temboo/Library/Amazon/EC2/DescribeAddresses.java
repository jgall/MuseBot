...
*/
public class DescribeAddresses extends Choreography {

	/**
	Create a new instance of the DescribeAddresses Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public DescribeAddresses(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Amazon/EC2/DescribeAddresses"));
	}
	...
	*/
	 ...
	 */
	@Override
	public DescribeAddressesResultSet run() {
		JSONObject result = super.runWithResults();
		return new DescribeAddressesResultSet(result);
	}
