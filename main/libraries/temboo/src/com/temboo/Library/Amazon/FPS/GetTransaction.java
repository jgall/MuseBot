...
*/
public class GetTransaction extends Choreography {

	/**
	Create a new instance of the GetTransaction Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public GetTransaction(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Amazon/FPS/GetTransaction"));
	}
	...
	*/
	 ...
	 */
	@Override
	public GetTransactionResultSet run() {
		JSONObject result = super.runWithResults();
		return new GetTransactionResultSet(result);
	}
