...
*/
public class DescribeTags extends Choreography {

	/**
	Create a new instance of the DescribeTags Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public DescribeTags(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Amazon/EC2/DescribeTags"));
	}
	...
	*/
	 ...
	 */
	@Override
	public DescribeTagsResultSet run() {
		JSONObject result = super.runWithResults();
		return new DescribeTagsResultSet(result);
	}
