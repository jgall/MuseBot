...
*/
public class DeleteSecurityGroup extends Choreography {

	/**
	Create a new instance of the DeleteSecurityGroup Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public DeleteSecurityGroup(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Amazon/EC2/DeleteSecurityGroup"));
	}
	...
	*/
	 ...
	 */
	@Override
	public DeleteSecurityGroupResultSet run() {
		JSONObject result = super.runWithResults();
		return new DeleteSecurityGroupResultSet(result);
	}
