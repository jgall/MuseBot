...
*/
public class GetBucketACL extends Choreography {

	/**
	Create a new instance of the GetBucketACL Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public GetBucketACL(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Amazon/S3/GetBucketACL"));
	}
	...
	*/
	 ...
	 */
	@Override
	public GetBucketACLResultSet run() {
		JSONObject result = super.runWithResults();
		return new GetBucketACLResultSet(result);
	}
