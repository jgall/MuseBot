...
*/
public class CancelFulfillmentOrder extends Choreography {

	/**
	Create a new instance of the CancelFulfillmentOrder Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public CancelFulfillmentOrder(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Amazon/Marketplace/OutboundShipments/CancelFulfillmentOrder"));
	}
	...
	*/
	public void setSellerFulfillmentOrderId(String value) {
		this.inputs.setInput("SellerFulfillmentOrderId", value);
	}
	 ...
	 */
	@Override
	public CancelFulfillmentOrderResultSet run() {
		JSONObject result = super.runWithResults();
		return new CancelFulfillmentOrderResultSet(result);
	}
