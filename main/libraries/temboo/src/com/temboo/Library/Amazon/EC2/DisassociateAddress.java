...
*/
public class DisassociateAddress extends Choreography {

	/**
	Create a new instance of the DisassociateAddress Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public DisassociateAddress(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Amazon/EC2/DisassociateAddress"));
	}
	...
	*/
	public void setAssociationId(String value) {
		this.inputs.setInput("AssociationId", value);
	}
	...
	*/
	 ...
	 */
	@Override
	public DisassociateAddressResultSet run() {
		JSONObject result = super.runWithResults();
		return new DisassociateAddressResultSet(result);
	}
