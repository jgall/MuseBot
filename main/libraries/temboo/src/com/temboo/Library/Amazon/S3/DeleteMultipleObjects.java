...
*/
public class DeleteMultipleObjects extends Choreography {

	/**
	Create a new instance of the DeleteMultipleObjects Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public DeleteMultipleObjects(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Amazon/S3/DeleteMultipleObjects"));
	}
	...
	*/
	public void setFileNames(String value) {
		this.inputs.setInput("FileNames", value);
	}
	 ...
	 */
	@Override
	public DeleteMultipleObjectsResultSet run() {
		JSONObject result = super.runWithResults();
		return new DeleteMultipleObjectsResultSet(result);
	}
