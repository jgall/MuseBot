...
*/
public class DeleteSnapshot extends Choreography {

	/**
	Create a new instance of the DeleteSnapshot Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public DeleteSnapshot(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Amazon/EC2/DeleteSnapshot"));
	}
	...
	*/
	 ...
	 */
	@Override
	public DeleteSnapshotResultSet run() {
		JSONObject result = super.runWithResults();
		return new DeleteSnapshotResultSet(result);
	}
