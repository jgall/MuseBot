...
*/
public class DeleteBucketWebsite extends Choreography {

	/**
	Create a new instance of the DeleteBucketWebsite Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public DeleteBucketWebsite(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Amazon/S3/DeleteBucketWebsite"));
	}
	...
	*/
	 ...
	 */
	@Override
	public DeleteBucketWebsiteResultSet run() {
		JSONObject result = super.runWithResults();
		return new DeleteBucketWebsiteResultSet(result);
	}
