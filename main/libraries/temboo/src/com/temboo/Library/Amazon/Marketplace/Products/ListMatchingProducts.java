...
*/
public class ListMatchingProducts extends Choreography {

	/**
	Create a new instance of the ListMatchingProducts Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public ListMatchingProducts(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Amazon/Marketplace/Products/ListMatchingProducts"));
	}
	...
	*/
	 ...
	 */
	@Override
	public ListMatchingProductsResultSet run() {
		JSONObject result = super.runWithResults();
		return new ListMatchingProductsResultSet(result);
	}
