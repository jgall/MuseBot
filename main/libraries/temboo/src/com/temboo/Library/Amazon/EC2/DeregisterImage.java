...
*/
public class DeregisterImage extends Choreography {

	/**
	Create a new instance of the DeregisterImage Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public DeregisterImage(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Amazon/EC2/DeregisterImage"));
	}
	...
	*/
	 ...
	 */
	@Override
	public DeregisterImageResultSet run() {
		JSONObject result = super.runWithResults();
		return new DeregisterImageResultSet(result);
	}
