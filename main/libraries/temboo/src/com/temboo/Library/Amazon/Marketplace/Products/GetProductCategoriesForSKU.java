...
*/
public class GetProductCategoriesForSKU extends Choreography {

	/**
	Create a new instance of the GetProductCategoriesForSKU Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public GetProductCategoriesForSKU(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Amazon/Marketplace/Products/GetProductCategoriesForSKU"));
	}
	...
	*/
	 ...
	 */
	@Override
	public GetProductCategoriesForSKUResultSet run() {
		JSONObject result = super.runWithResults();
		return new GetProductCategoriesForSKUResultSet(result);
	}
