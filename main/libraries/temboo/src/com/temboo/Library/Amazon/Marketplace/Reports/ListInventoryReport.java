...
*/
public class ListInventoryReport extends Choreography {

	/**
	Create a new instance of the ListInventoryReport Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public ListInventoryReport(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Amazon/Marketplace/Reports/ListInventoryReport"));
	}
	...
	*/
	 ...
	 */
	@Override
	public ListInventoryReportResultSet run() {
		JSONObject result = super.runWithResults();
		return new ListInventoryReportResultSet(result);
	}
