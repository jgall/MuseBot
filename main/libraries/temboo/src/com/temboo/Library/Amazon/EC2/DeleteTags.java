...
*/
public class DeleteTags extends Choreography {

	/**
	Create a new instance of the DeleteTags Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public DeleteTags(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Amazon/EC2/DeleteTags"));
	}
	...
	*/
	 ...
	 */
	@Override
	public DeleteTagsResultSet run() {
		JSONObject result = super.runWithResults();
		return new DeleteTagsResultSet(result);
	}
