...
*/
public class GetBucketVersioning extends Choreography {

	/**
	Create a new instance of the GetBucketVersioning Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public GetBucketVersioning(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Amazon/S3/GetBucketVersioning"));
	}
	...
	*/
	 ...
	 */
	@Override
	public GetBucketVersioningResultSet run() {
		JSONObject result = super.runWithResults();
		return new GetBucketVersioningResultSet(result);
	}
