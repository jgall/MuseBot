...
*/
public class AllocateAddress extends Choreography {

	/**
	Create a new instance of the AllocateAddress Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public AllocateAddress(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Amazon/EC2/AllocateAddress"));
	}
	...
	*/
	 ...
	 */
	@Override
	public AllocateAddressResultSet run() {
		JSONObject result = super.runWithResults();
		return new AllocateAddressResultSet(result);
	}
