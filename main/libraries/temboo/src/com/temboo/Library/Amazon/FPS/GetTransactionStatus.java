...
*/
public class GetTransactionStatus extends Choreography {

	/**
	Create a new instance of the GetTransactionStatus Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public GetTransactionStatus(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Amazon/FPS/GetTransactionStatus"));
	}
	...
	*/
	 ...
	 */
	@Override
	public GetTransactionStatusResultSet run() {
		JSONObject result = super.runWithResults();
		return new GetTransactionStatusResultSet(result);
	}
