...
*/
public class CreateKeyPair extends Choreography {

	/**
	Create a new instance of the CreateKeyPair Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public CreateKeyPair(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Amazon/EC2/CreateKeyPair"));
	}
	...
	*/
	 ...
	 */
	@Override
	public CreateKeyPairResultSet run() {
		JSONObject result = super.runWithResults();
		return new CreateKeyPairResultSet(result);
	}
