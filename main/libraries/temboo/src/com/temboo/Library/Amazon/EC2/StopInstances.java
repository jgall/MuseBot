...
*/
public class StopInstances extends Choreography {

	/**
	Create a new instance of the StopInstances Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public StopInstances(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Amazon/EC2/StopInstances"));
	}
	...
	*/
	 ...
	 */
	@Override
	public StopInstancesResultSet run() {
		JSONObject result = super.runWithResults();
		return new StopInstancesResultSet(result);
	}
