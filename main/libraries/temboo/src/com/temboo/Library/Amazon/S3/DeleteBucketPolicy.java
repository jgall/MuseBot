...
*/
public class DeleteBucketPolicy extends Choreography {

	/**
	Create a new instance of the DeleteBucketPolicy Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public DeleteBucketPolicy(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Amazon/S3/DeleteBucketPolicy"));
	}
	...
	*/
	 ...
	 */
	@Override
	public DeleteBucketPolicyResultSet run() {
		JSONObject result = super.runWithResults();
		return new DeleteBucketPolicyResultSet(result);
	}
