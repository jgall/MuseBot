...
*/
public class GetReportById extends Choreography {

	/**
	Create a new instance of the GetReportById Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public GetReportById(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Amazon/Marketplace/Reports/GetReportById"));
	}
	...
	*/
	...
	@param String - (required, integer) The id of the report to retrieve.
	*/
	 ...
	 */
	@Override
	public GetReportByIdResultSet run() {
		JSONObject result = super.runWithResults();
		return new GetReportByIdResultSet(result);
	}
