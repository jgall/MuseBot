...
*/
public class DeleteQueue extends Choreography {

	/**
	Create a new instance of the DeleteQueue Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public DeleteQueue(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Amazon/SQS/DeleteQueue"));
	}
	...
	*/
	...
	@param String - (required, integer) The id for the AWS account associated with the queue you're deleting a message from (remove all dashes in the account number).
	*/
	...
	*/
	 ...
	 */
	@Override
	public DeleteQueueResultSet run() {
		JSONObject result = super.runWithResults();
		return new DeleteQueueResultSet(result);
	}
