...
*/
public class DeleteBucketLifecycle extends Choreography {

	/**
	Create a new instance of the DeleteBucketLifecycle Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public DeleteBucketLifecycle(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Amazon/S3/DeleteBucketLifecycle"));
	}
	...
	*/
	 ...
	 */
	@Override
	public DeleteBucketLifecycleResultSet run() {
		JSONObject result = super.runWithResults();
		return new DeleteBucketLifecycleResultSet(result);
	}
