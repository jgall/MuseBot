...
*/
public class GetCompetitivePricingForASIN extends Choreography {

	/**
	Create a new instance of the GetCompetitivePricingForASIN Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public GetCompetitivePricingForASIN(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Amazon/Marketplace/Products/GetCompetitivePricingForASIN"));
	}
	...
	*/
	 ...
	 */
	@Override
	public GetCompetitivePricingForASINResultSet run() {
		JSONObject result = super.runWithResults();
		return new GetCompetitivePricingForASINResultSet(result);
	}
