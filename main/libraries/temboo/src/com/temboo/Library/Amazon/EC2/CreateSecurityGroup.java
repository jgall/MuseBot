...
*/
public class CreateSecurityGroup extends Choreography {

	/**
	Create a new instance of the CreateSecurityGroup Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public CreateSecurityGroup(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Amazon/EC2/CreateSecurityGroup"));
	}
	...
	*/
	public void setGroupDescription(String value) {
		this.inputs.setInput("GroupDescription", value);
	}
	...
	*/
	public void setVpcId(String value) {
		this.inputs.setInput("VpcId", value);
	}
	 ...
	 */
	@Override
	public CreateSecurityGroupResultSet run() {
		JSONObject result = super.runWithResults();
		return new CreateSecurityGroupResultSet(result);
	}
