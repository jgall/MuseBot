...
*/
public class UnshippedOrdersReport extends Choreography {

	/**
	Create a new instance of the UnshippedOrdersReport Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public UnshippedOrdersReport(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Amazon/Marketplace/Reports/UnshippedOrdersReport"));
	}
	...
	*/
	 ...
	 */
	@Override
	public UnshippedOrdersReportResultSet run() {
		JSONObject result = super.runWithResults();
		return new UnshippedOrdersReportResultSet(result);
	}
